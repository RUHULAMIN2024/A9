  ...
  return (
    <div className="navbar animate__fadeInDown animate__animated container mx-auto sticky top-0 z-10 my-3 bg-base-100">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost font-semibold text-green-500 text-2xl md:text-2xl">
      ...
      <div className="navbar-end">

        {
          userInfo ? <><button onClick={() => logout()} className="btn mr-3 bg-green-500 btn-ghost">Logout</button>
              <div className="w-10 h-10 tooltip tooltip-bottom" data-tip={userInfo.displayName}>
                <button><img className="rounded-full w-10 h-10" alt="" src={userInfo?.photoURL} /></button>
              </div>
          </>
            :
